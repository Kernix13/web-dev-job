...
- **Browser DevTools**: (console, network, storage, etc) ??? errors, - network tab shows the requests & responses that are made to & from servers, Application tab is used to work with local storage in the browser, ...
